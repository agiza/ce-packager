...
function getUnlimited()
{
	return '<div id="status_normal class="passed">
				<h1 class="passed">
				<strong>Your Kaltura On-Prem installation is currently active</strong>
				</h1>
				</div>';
}
...
function getInstallFailed()
{
	return '<div id="install_failed" class="failed">
				<h1><span class="status_error">The installation of your
				Kaltura Community Edition has not been completed.</span></h1>
